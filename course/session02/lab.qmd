...
Run this only with the instructor or TA. Replace the username placeholder with
your GitHub username. Use the plain HTTPS URL—without Markdown brackets or
parentheses.
...
setup recipe, not commands you are expected to memorize. The first push may open
a GitHub browser sign-in through Git Credential Manager or GitHub CLI. Complete
authentication in the browser. If the terminal requests a GitHub password,
cancel and ask for help; do not enter your account password.
:::
...
3. Click **Push**.
4. If GitHub opens in a browser, complete sign-in and two-factor authentication
   there, then return to RStudio.

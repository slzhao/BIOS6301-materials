...
[6]{.objective-num} Give course staff access to a private homework repository.
...
## Give course staff access without making the repository public {.smaller}

![](images/github-repository-settings.png){fig-alt="GitHub repository header with the Settings tab highlighted" width="96%"}

In `BIOS6301-mywork`:

1. **Settings → Collaborators → Add people**
2. Invite instructor `slzhao`.
3. Invite TA `zongyue.teng@Vanderbilt.Edu`.
4. Leave the repository **Private**.
